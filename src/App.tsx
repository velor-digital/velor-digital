...
function ChatWidget() {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: "Hi! I'm Aria, Lumio's AI support agent. Ask me anything ",
    },
  ]);
  ...
  return (
    <div
      style={{
        ...
        overflow: 'hidden',
        boxShadow: `0 0 0 1px rgba(0,212,170,0.1), 0 40px 100px rgba(0,0,0,0.6), 0 0 60px rgba(0,212,170,0.08)`,
      }}
    >
      {/* Header */}
      <div
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
            <path
              ...
              stroke={input.trim() ? '#060d1a' : '#475569'}
              strokeWidth="2.5"
              strokeLinecap="round"
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, position: 'relative', zIndex: 1 }}>
            ...
            >
              Resolve <span style={{ color: '#00d4aa' }}>70%</span> of
              <br />
              support tickets
              <br />
              <span style={{ color: '#475569' }}>before humans</span>
              <br />
              even see them.
            </h1>
            ...
            >
              We build custom AI support agents for mid-market companies — fully
              integrated with your helpdesk, live in 30 days.
            </p>
          ...
          >
            ...
            >
              ↑ This is a live AI agent — type anything
            </p>
          </div>
        </section>
        ...
        >
          ...
          >
            {[
              ['70%', 'Average ticket deflection'],
              ['< 3s', 'AI response time'],
              ['30 days', 'Avg time to go live'],
        ...
        >
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            ...
            >
              We handle the full stack — AI brain, integrations, training, and
          ...
          >
            {[
              [
                ' ',
                'Claude-Powered AI',
                "Built on Anthropic's Claude — the most accurate AI for nuanced support conversations.",
                '0s',
              ],
              [
                ' ',
                'Helpdesk Integration',
                'Plugs into Zendesk, Freshdesk, Intercom, and HubSpot out of the box.',
                '0.1s',
              ],
              [
                ' ',
                'Trained on Your Docs',
                'We ingest your FAQs, SOPs, and policies so the AI knows your business.',
                '0.2s',
              ],
              [
                ' ',
                'Smart Escalation',
                'Detects frustration and complexity — hands off to humans with full context.',
                '0.3s',
              ],
              [
                ' ',
                'Live Reporting',
                'Track deflection rate, CSAT, and cost savings in a real-time dashboard.',
                '0.4s',
              ],
              [
                ' ',
                'Enterprise Security',
                'SOC 2 compatible, GDPR-ready, data stays in your region.',
                '0.5s',
              ],
        ...
        <section
          style={{
            ...
            textAlign: 'center',
            background:
              'linear-gradient(180deg, transparent, rgba(0,212,170,0.04) 50%, transparent)',
          }}
        >
          <h2
            style={{
          ...
          <p style={{ color: '#64748b', fontSize: 16, marginBottom: 32 }}>
            Free audit · No commitment · Live in 30 days
          </p>
          <button
            style={{
              background: 'linear-gradient(135deg, #00d4aa, #00b8d9)',
